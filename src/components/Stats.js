        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center hover:border-white/20 transition-all duration-300 h-full flex flex-col justify-between"
            >
              <motion.div 
